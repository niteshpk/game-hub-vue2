...
export default {
    ...
    computed: {
        description() {
            return this.expanded ? this.summary : this.summary.substring(0, limit) + '...';
        }
    }
}
</script>